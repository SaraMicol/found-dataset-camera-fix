...
def visualize(scene_path, cfg):
    ...
    # scene_depth_data_copy = copy.deepcopy(scene_depth_data)

    # scene_data_copy['means3D'] = scene_data_copy['means3D'][indices_z, :]
    # scene_data_copy['colors_precomp'] = scene_data_copy['colors_precomp'][indices_z, :]
    # scene_data_copy['rotations'] = scene_data_copy['rotations'][indices_z, :]
    # scene_data_copy['opacities'] = scene_data_copy['opacities'][indices_z, :]
    # scene_data_copy['scales'] = scene_data_copy['scales'][indices_z, :]
    # scene_data_copy['means2D'] = scene_data_copy['means2D'][indices_z, :]

    # scene_depth_data_copy['means3D'] = scene_depth_data_copy['means3D'][indices_z, :]
    # scene_depth_data_copy['colors_precomp'] = scene_depth_data_copy['colors_precomp'][indices_z, :]
    # scene_depth_data_copy['rotations'] = scene_depth_data_copy['rotations'][indices_z, :]
    # scene_depth_data_copy['opacities'] = scene_depth_data_copy['opacities'][indices_z, :]
    # scene_depth_data_copy['scales'] = scene_depth_data_copy['scales'][indices_z, :]
    # scene_depth_data_copy['means2D'] = scene_depth_data_copy['means2D'][indices_z, :]
